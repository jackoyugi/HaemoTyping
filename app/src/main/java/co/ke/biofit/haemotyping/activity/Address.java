...
public class Address {
     ...
     * @param slug
     */
    public Address(String city, Integer lat, Integer lon, Slug_ slug, String state, String stateLong, String street, String street2, String zip) {
        super();
        this.city = city;
        this.lat = lat;
        this.lon = lon;
    ...
    public Slug_ getSlug() {
        return slug;
    }

    public void setSlug(Slug_ slug) {
        this.slug = slug;
    }
