...
public class Claim_ {
     ...
     * @param hcpcs
     */
    public Claim_(String hcpcs, String hcpcsDescription, Integer serviceCnt, Integer beneUniqCnt, Integer avgAllowedAmt, Integer avgChargeAmt, Integer avgPaymentAmt) {
        super();
        this.hcpcs = hcpcs;
