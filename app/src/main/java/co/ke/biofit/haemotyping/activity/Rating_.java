...
public class Rating_ {
     ...
     * @param providerUid
     */
    public Rating_(Boolean active, String provider, String providerUid, String providerUrl, Integer rating, Integer reviewCount, String imageUrlSmall, String imageUrlSmall2x, String imageUrlLarge, String imageUrlLarge2x) {
        super();
        this.active = active;
